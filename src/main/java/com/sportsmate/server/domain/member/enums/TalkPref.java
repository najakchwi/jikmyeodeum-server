...
public enum TalkPref implements ProfileOption {
    TALKATIVE("talkative", "말 많은 편", ""),
    QUIET("quiet", "조용한 편", ""),
    ANY("any", "무관", "");
    ...
    TalkPref(String value, String label, String description) {
        this.value = value;
        this.label = label;
    ...
    @JsonCreator
    public static TalkPref from(String value) {
