...
INSERT INTO match_applications
    (id, member_id, game_id, match_id, matched_member_id, matched_at, expires_at, response, party_size, status, applied_at, cancelled_at)
VALUES
    (1,  1,  1, NULL, NULL, NULL,                         NULL,                         NULL,       1, 'waiting',   TIMESTAMP '2026-06-22 09:00:00', NULL),
    (2,  1,  3, NULL, 2,    TIMESTAMP '2026-06-22 09:30:00', TIMESTAMP '2026-06-23 08:30:00', NULL,       1, 'matched',   TIMESTAMP '2026-06-22 09:10:00', NULL),
    (3,  2,  3, NULL, 1,    TIMESTAMP '2026-06-22 09:30:00', TIMESTAMP '2026-06-23 08:30:00', NULL,       1, 'matched',   TIMESTAMP '2026-06-22 09:20:00', NULL),
    (4,  1,  8, 1,    8,    TIMESTAMP '2026-06-22 10:00:00', TIMESTAMP '2026-06-23 09:00:00', 'accepted', 1, 'chatting',  TIMESTAMP '2026-06-22 09:40:00', NULL),
    (5,  8,  8, 1,    1,    TIMESTAMP '2026-06-22 10:00:00', TIMESTAMP '2026-06-23 09:00:00', 'accepted', 1, 'chatting',  TIMESTAMP '2026-06-22 09:45:00', NULL),
    (6,  1, 18, NULL, NULL, NULL,                         NULL,                         NULL,       1, 'cancelled', TIMESTAMP '2026-06-22 10:10:00', TIMESTAMP '2026-06-22 10:20:00'),
    (7,  1, 48, 2,    6,    TIMESTAMP '2026-06-22 11:00:00', TIMESTAMP '2026-06-23 10:00:00', 'accepted', 1, 'game_done', TIMESTAMP '2026-06-22 10:30:00', NULL),
    (8,  6, 48, 2,    1,    TIMESTAMP '2026-06-22 11:00:00', TIMESTAMP '2026-06-23 10:00:00', 'accepted', 1, 'game_done', TIMESTAMP '2026-06-22 10:35:00', NULL),
    (9,  1, 68, 3,    7,    TIMESTAMP '2026-06-22 12:00:00', TIMESTAMP '2026-06-23 11:00:00', 'accepted', 1, 'reviewed',  TIMESTAMP '2026-06-22 11:30:00', NULL),
    (10, 7, 68, 3,    1,    TIMESTAMP '2026-06-22 12:00:00', TIMESTAMP '2026-06-23 11:00:00', 'accepted', 1, 'reviewed',  TIMESTAMP '2026-06-22 11:35:00', NULL)
ON CONFLICT (id) DO NOTHING;
